      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto prose prose-blue prose-lg">
          ...
          <div className="mb-8">
            ...
            <p>
              We ship to addresses within India only. Delivery times typically take 3-5 working days after processing, but are estimates and not guaranteed. Delays can occur due to weather conditions, postal delays, or other factors beyond our control.
            </p>
            <p>
            ...
            <p>
              For live aquatic plants, we take special precautions for shipping, but we cannot guarantee 100% survival due to the nature of these products.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p>
              We do not accept returns for any products. Please review product details carefully before placing your order.
            </p>
            <p>
              Refunds are only eligible when you receive plants dead on arrival. An unboxing video is mandatory for refund processing.
            </p>
            <p>
              To request a refund for dead-on-arrival plants, please email us at mahesh@aquaticexotica.com within 24 hours of receiving your order. Include your order number, unboxing video, and clear photos of the affected plants.
            </p>
          </div>
